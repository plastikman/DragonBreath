...
print(json.dumps({
    ...
    "shared_core":{"source":"github.com/justinh-rahb/dragon-core","ref":"fca2e3f6ae9b0497242e205d05c4aba9753d391a","license":"MIT","components":["dc_evlog","dc_source","dc_bambu","dc_wifi","dc_moonraker","dc_ui"]},
