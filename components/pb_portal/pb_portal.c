...
static const char STATUS_BODY[] =
    ...
    "<input id=atin type=number min=30 step=1 value=45>"
    ...
    "<input id=dtin type=number min=30 step=1 value=55>"
    ...
    ".then(function(){note('amsg',last&&last.environment.auto_engaged?'Automatic active.':'Automatic armed; waiting for bed threshold.');})"
